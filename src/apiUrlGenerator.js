...
//     //make api call to get all UPCOMING assignments
//     var assignment = await API.regularCanvasAPICall(`${process.env.CANVAS_BASE_URL}/courses/${course.course_id}/assignments?bucket=upcoming`, requestOptions, client);
